...
pub fn sign_message_ed25519(keypair_bytes: &[u8; 64], message: &[u8]) -> HmacsResult<[u8; 64]> {
    use ed25519_dalek::{Signer, SigningKey};
    let signing_key = SigningKey::from_keypair_bytes(keypair_bytes)
        .map_err(|e| hmacs_core::HmacsError::Internal(format!("Invalid keypair: {}", e)))?;
